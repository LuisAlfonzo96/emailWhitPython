...
def consultaBD():
    #SEMANAL
    query_semanal_neiva_inv1 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66f4951876687205222' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_neiva_inv2 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '6704951876687205326' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_neiva_inv3 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '6744951876687205129' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_mosquera_inv1 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66c54498366871952' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_mosquera_inv2 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66854498366871952' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC"
    query_semanal_medellin_inv1_p12 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '6714951876687205329' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC"
    ...
    query_semanal_medellin_inv3_p12 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '6664951876687205226' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_medellin_inv1_tn ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '6704951876687204835' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_medellin_inv2_tn ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66a4951876687204832' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_medellin_inv1_p6 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66d4951876687205218' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    ...
    query_semanal_giron_inv1 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '6694951876687205125' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_giron_inv2 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66e4951876687205128' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_giron_inv3 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '6644951876687205123' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    ...
    query_semanal_giron_inv5 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66a4951876687205029' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_giron_inv6 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66d4951876687205334' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    ...
    query_semanal_monteria_inv2 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66e4951876687205034' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_cartagena_inv1 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66a4951876687204839' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_cartagena_inv2 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66e4951876687205031' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_cartagena_inv3 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66e4951876687205034' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_cartagena_inv4 ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '6724951876687205324' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_valledupar_inv1_hangar ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66f4951876687205132' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    ...
    query_semanal_valledupar_inv3_hangar ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66c4951876687204836' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_valledupar_inv4_hangar ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66b4951876687205131' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_valledupar_inv5_hangar ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66b4951876687205032' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_valledupar_inv6_hangar ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/5040) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '6684951876687205130' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_valledupar_inv1_riego ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/10080) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66e4951876687205217' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
    query_semanal_valledupar_inv2_riego ="SELECT COUNT(*) as Conteo, (COUNT(*)*100/10080) as Porcentaje, (MAX(CAST(E_G as DECIMAL(10,2))) - MIN(CAST(E_G as DECIMAL(10,2))))/10000 EnergiaGen, ((MAX(CAST(E_C1 as DECIMAL(10,2))) + MAX(CAST(E_C2 as DECIMAL(10,2))) + MAX(CAST(E_C3 as DECIMAL(10,2)))) - (MIN(CAST(E_C1 as DECIMAL(10,2))) + MIN(CAST(E_C2 as DECIMAL(10,2))) + MIN(CAST(E_C3 as DECIMAL(10,2)))))/10000 as EnergiaCon FROM `central_saas`.Data_Sena WHERE SER = '66b4951876687205332' AND FECHA BETWEEN '2022-03-07 00:00:00' AND '2022-03-13 23:59:59' ORDER BY FECHA DESC" 
