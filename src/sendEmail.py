...
def crearCuerpoHtml(fechaInicio,  fechaFinal):
  consultaBD(fechaInicio, fechaFinal)
  ...
  return cuerpoHtml+cuerpoHtml2

def emailCheck(_email, subject, fechaInicio, fechaFinal):
    #msg = MIMEMultipart()
  ...
  # add in the message body
    ...
    msg.set_payload(crearCuerpoHtml(fechaInicio, fechaFinal))
...
def emailWhitPost(_email, subject, messages):
    #msg = MIMEMultipart()
    msg = email.message.Message()
    #message = messages
